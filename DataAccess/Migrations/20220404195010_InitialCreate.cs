        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientDistrict = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PatientNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PatientSGK = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PatientMail = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Laboratorys", x => x.LabId);
                    table.ForeignKey(
                        name: "FK_Laboratorys_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "PatientId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorTc = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DoctorArea = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Doctors_Laboratorys_LaboratoryId",
